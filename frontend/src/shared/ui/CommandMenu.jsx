                ...
                <DialogPrimitive.Content className="fixed left-[50%] top-[50%] z-[101] w-full max-w-[640px] translate-x-[-50%] translate-y-[-50%] p-4 animate-in fade-in zoom-in duration-200">
                    <Command className="w-full bg-white dark:bg-black rounded-xl border shadow-2xl overflow-hidden flex flex-col">
                        ...
                        <Command.List className="max-h-[400px] overflow-y-auto p-2 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
                            ...
                            <Command.Group heading="Navigation" className="px-2 py-3 text-xs font-bold text-primary  widest opacity-70">
                            ...
                            <Command.Group heading="Account" className="px-2 py-3 text-xs font-bold text-primary  widest opacity-70">
                            ...
                            <Command.Group heading="Theme" className="px-2 py-3 text-xs font-bold text-primary  widest opacity-70">
                            ...
                            <Command.Group heading="Action" className="px-2 py-3 text-xs font-bold text-primary  widest opacity-70">
