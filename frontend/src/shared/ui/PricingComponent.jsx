  ...
  return (
    <section className="bg-pearl dark:bg-ebony py-24 px-6 md:px-20 font-display transition-colors duration-300">
      <div className="max-w-7xl mx-auto text-center mb-12 md:mb-20">
        ...
        <p className="text-[10px] sm:text-sm  [0.2em] sm:[0.3em] text-gold font-semibold">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <Card className="bg-white dark:bg-[#2a261d] p-0 rounded-2xl border border-gold/10 hover:border-gold/30 transition-all flex flex-col h-full">
              ...
              <CardFooter className="p-8 pt-4 border-t border-gray-100 dark:border-gray-800">
                <Button asChild variant="outline" className="w-full text-sm font-semibold wide border-gold/50 text-gold hover:bg-gold hover:text-white transition-all h-12">
            ...
            <Card className="bg-ebony dark:bg-gold p-0 rounded-2xl border-2 border-gold shadow-xl md:-translate-y-4 relative z-10 flex flex-col h-full">
              <div className="absolute top-0 inset-x-0 -translate-y-1/2 flex justify-center">
                <Badge className="bg-gold dark:bg-ebony text-white dark:text-gold px-4 py-1.5 rounded-full text-xs font-bold  wider border-none shadow-sm">
                  Most Popular
                </Badge>
              </div>
              <CardHeader className="p-8 pb-4">
              ...
              <CardFooter className="p-8 pt-4 border-t border-gray-800 dark:border-white/20">
                <Button asChild className="w-full text-sm font-bold wide bg-gold hover:bg-gold/90 text-white dark:bg-black dark:hover:bg-black/90 dark:text-gold transition-all h-12">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <Card className="bg-white dark:bg-[#2a261d] p-0 rounded-2xl border border-gray-200 dark:border-gray-800 hover:border-gold/30 transition-all flex flex-col h-full">
              ...
              <CardFooter className="p-8 pt-4 border-t border-gray-100 dark:border-gray-800">
                <Button asChild variant="outline" className="w-full text-sm font-semibold wide border-gray-300 hover:bg-gray-50 text-gray-700 dark:border-gray-700 dark:text-gray-300 dark:hover:bg-gray-800 transition-all h-12">
            ...
            <Card className="bg-white dark:bg-[#2a261d] p-0 rounded-2xl border-2 border-indigo-500/30 dark:border-indigo-400/50 shadow-lg relative flex flex-col h-full">
              <div className="absolute top-0 right-8 -translate-y-1/2">
                <Badge className="bg-indigo-500 text-white px-3 py-1 rounded-full text-[10px] font-semibold  widest border-none">
              ...
              <CardFooter className="p-8 pt-4 border-t border-gray-100 dark:border-gray-800">
                <Button asChild className="w-full text-sm font-semibold wide bg-indigo-600 hover:bg-indigo-700 text-white transition-all h-12">
