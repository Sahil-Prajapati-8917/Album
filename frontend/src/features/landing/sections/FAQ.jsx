                    ...
                    <div ref={ctaRef} className="mt-16 text-center opacity-0">
                        ...
                        {faqConfig.ctaButtonText && (
                            <a
                                ...
                                className="inline-flex items-center gap-2 px-8 py-4 bg-[#C6A75E] text-white font-sans font-semibold text-sm rounded-sm hover:bg-[#8F6A2A] transition-colors duration-300"
                            >
                                {faqConfig.ctaButtonText}
