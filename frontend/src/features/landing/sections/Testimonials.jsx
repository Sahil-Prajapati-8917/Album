                ...
                >
                    {testimonialsConfig.testimonials.map((testimonial) => (
                        <SwiperSlide key={testimonial.id}>
                            <div className="group bg-[#F8F8F6] rounded-lg p-8 md:p-10 h-full transition-all duration-500 hover:bg-[#111111] hover:text-white border border-transparent hover:border-[#C6A75E]/30">
                                {/* Quote icon */}
                                <Quote className="w-10 h-10 text-[#C6A75E]/30 group-hover:text-[#C6A75E]/40 mb-6 transition-colors duration-500" strokeWidth={1} />

                                {/* Quote text */}
                                <p className="text-[#111111]/80 group-hover:text-white/90 font-body text-base md:text-lg leading-relaxed mb-8 transition-colors duration-500">
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p className="font-sans font-semibold text-[#111111] group-hover:text-white transition-colors duration-500">
                                            {testimonial.name}
                                        </p>
                                        <p className="text-sm text-[#111111]/50 group-hover:text-[#C6A75E] font-body transition-colors duration-500">
                                            {testimonial.role}
                                        </p>
                                    </div>
                                </div>
