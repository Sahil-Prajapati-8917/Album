...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex items-center justify-center p-4 md:p-8 text-slate-900 dark:text-slate-100 selection:bg-primary/15">
      <div className="bg-white dark:bg-slate-900 rounded-[2rem] shadow-xl shadow-black/5 dark:shadow-black/30 flex w-full max-w-[1200px] min-h-[700px] overflow-hidden border border-slate-200/80 dark:border-slate-800 relative">
        ...
        <div className="w-full lg:w-1/2 p-8 md:p-12 lg:p-16 flex flex-col relative z-10">
          ...
          <div className="flex-1 flex flex-col justify-center">
            <div className="w-full max-w-[400px] space-y-8 animate-fade-in mx-auto ml-0">
              ...
              <div className="space-y-3">
                ...
                <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-slate-900 dark:text-white">Sign in to your account</h1>
                <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed max-w-[320px]">Enter your details below to access your workspace and manage your portfolio.</p>
              </div>
          ...
          <div className="mt-auto pt-8">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[11px] text-slate-500 dark:text-slate-400 font-medium">Join 1000+ professionals</span>
            </div>
          </div>
