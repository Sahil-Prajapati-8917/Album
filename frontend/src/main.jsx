  ...
  plans: [
    {
      ...
      price: '$29',
      period: '/ month',
      description: 'For emerging photographers building their portfolio.',
      features: [
        'Up to 10 albums',
    ...
    },
    {
      ...
      price: '$79',
      period: '/ month',
      description: 'For established photographers delivering consistently.',
      features: [
        'Unlimited albums',
    ...
    },
    {
      ...
      price: '$199',
      period: '/ month',
      description: 'For multi-photographer studios scaling their operations.',
      features: [
