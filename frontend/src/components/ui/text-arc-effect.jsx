...
const CentralLogo = () => (
  <img
    src="https://images.unsplash.com/photo-1527842891421-42eec6e703ea?q=80&w=387&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
    alt="Logo"
...
export default function TextArcEffect() {
    ...
    return (
        <div className="flex items-center justify-center w-full min-h-screen bg-white transition-colors duration-500">
