      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-20">
          ...
          <div className="space-y-6">
            <h4 className="font-bold uppercase tracking-[0.2em] text-[11px] text-zinc-400">Navigation</h4>
          ...
          <div className="space-y-6">
            <h4 className="font-bold uppercase tracking-[0.2em] text-[11px] text-zinc-400">Connect</h4>
            <ul className="space-y-4 text-sm font-medium text-zinc-600 dark:text-zinc-400">
          ...
          <div className="space-y-6">
            <h4 className="font-bold uppercase tracking-[0.2em] text-[11px] text-zinc-400">Inquiries</h4>
            <div className="space-y-4 text-sm font-bold text-zinc-900 dark:text-white uppercase tracking-widest">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex gap-10 text-[10px] text-zinc-400 uppercase tracking-[0.2em] font-bold">
