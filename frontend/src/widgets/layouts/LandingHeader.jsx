    ...
    return (
        <header className={`fixed top-0 w-full z-50 transition-all duration-300 border-b border-border/10 bg-background shadow-sm`}>
            <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                ...
                <div className="hidden md:flex items-center gap-8 text-sm font-medium widest ">
                    ...
                    <ThemeToggle />
                    <Button asChild className="bg-primary text-primary-foreground px-6 py-2.5 rounded-sm text-sm font-bold  wider hover:bg-foreground hover:text-background transition-all shadow-lg shadow-primary/10 h-auto">
                ...
                <div className="flex items-center gap-4 md:hidden">
                    ...
                    <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
                        ...
                        <SheetContent side="top" className="p-6 pt-12">
                            ...
                            <nav className="flex flex-col gap-6 text-sm font-medium widest  items-center">
                                ...
                                <Button asChild onClick={() => setMobileMenuOpen(false)} className="w-full text-center bg-primary text-primary-foreground px-6 py-3 rounded-sm text-sm font-bold  wider hover:bg-foreground hover:text-background transition-all h-auto mt-4">
                                    <Link to="/signup">Join Now</Link>
                                </Button>
                            </nav>
                        </SheetContent>
