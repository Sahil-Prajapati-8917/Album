...
const items = [
  {
    id: "1",
    title: "What is Pixora?",
    content: "Pixora is an online Visual Book creator that helps photographers and studios present their albums in a modern, interactive format. You can even add your own branding."
  },
  {
    id: "2",
    title: "How does Pixora work?",
    content: "You upload your album photos, and Pixora automatically converts them into a smooth, interactive Visual Book. You can share it with clients using a simple link."
  },
  {
    id: "3",
    title: "What are Pixora's monthly plans?",
    content: "Pixora offers simple and affordable plans:\n\nFree Plan → Create up to 3 Visual Books\n\nPremium Plan ₹99/month → Create unlimited Visual Books anytime"
  },
  {
    id: "4",
    title: "Can I add branding or social media links in Pixora?",
    content: "Yes. Pixora allows you to add:\n\n• Studio / Photographer Name\n• Website link\n• All social media profiles\n• Contact Number\n• Location\n\nYour Visual Books will display your identity professionally."
  },
  {
    id: "5",
    title: "Can I add or change music in Pixora?",
  ...
  {
    id: "6",
    title: "Kya Pixora me mera data surakshit rahega?",
    content: "Bilkul. Pixora advanced security use karta hai:\n\n• Encrypted storage\n• Secure servers\n• Automated backups\n• No data sharing with third parties\n\nAapke Visual Books hamesha safe rehte hain."
  },
  {
    id: "7",
  ...
  {
    id: "8",
    title: "Does Pixora work offline?",
    content: "No. Pixora is a cloud-based platform and requires an internet connection to create or view Visual Books."
  },
  {
    id: "9",
    title: "Pixora albums kitne time tak store rahengi?",
    content: "Pixora albums long-term store hoti hain.\nAgar aapka plan expire ho jaye:\n\n• Your albums will continue to open\n• Only branding features may pause\n• The moment you reactivate a plan, branding restores\n\nYour albums never disappear unexpectedly."
  },
  {
    id: "10",
    title: "Kya Printing & Design Labs ke liye Pixora ka koi special version hai?",
    content: "Yes. Pixora offers a Lab Mode designed for high-volume album creation:\n\n• Faster processing for bulk Visual Books\n• Custom pricing models\n• Labs can create Visual Books for photographers\n• If photographer's personal plan is inactive, branding will not appear\n• Photographer needs personal login to enable their branding"
  },
  {
    id: "11",
    title: "Kya Pixora ka free trial available hai?",
    content: "Yes. Pixora offers a free trial for new users:\n\n• Create up to 3 free Visual Books\n• Explore all features\n• No payment needed"
  }
];
